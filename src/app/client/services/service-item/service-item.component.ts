...
export class ServiceItemComponent implements OnInit {
  ...
  addToCart() {
    ...
    let cartService = Object.assign({}, { service_id: this.service.id, name: this.service.service_title, price: this.service.service_price, quantity: 1, is_same_time: true, cartAddons: [] });
